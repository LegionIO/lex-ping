...
require 'legion/extensions/ping/runners/udp'

RSpec.describe Legion::Extensions::Ping::Runners::Udp do
  let(:runner) { Object.new.extend(described_class) }
  let(:ping_result) { instance_double(Net::Ping::UDP) }

  before do
    allow(Net::Ping::UDP).to receive(:new).and_return(ping_result)
  end
